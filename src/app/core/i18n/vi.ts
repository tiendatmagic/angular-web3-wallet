...
export const VI_TRANSLATIONS: TranslationDictionary = {
  ...
  home: {
    ...
    toast_wallet_unsupported_chain_or_method: 'Ví của bạn chưa hỗ trợ hoặc chưa chuyển sang mạng này trong ứng dụng ví. Vui lòng mở ứng dụng ví và chọn đúng mạng.'
  },
  cards: {
    buttons: {
  ...
  showcase: {
    ...
    tx_modal_title: 'Giao Dịch Đã Được Gửi!',
    tx_modal_subtitle: 'Giao dịch đã được phát tán thành công lên mạng lưới Blockchain',
    tx_modal_hash_label: 'MÃ GIAO DỊCH (TX HASH)',
    tx_modal_view_explorer: 'Xem trên {explorer}',
    tx_modal_amount: 'Số lượng gửi',
    tx_modal_recipient: 'Địa chỉ nhận',
    tx_modal_network: 'Mạng lưới',
    tx_modal_status_broadcasted: 'Đã gửi vào Mempool',
    tx_modal_btn_close: 'Đã Hiểu / Đóng',
