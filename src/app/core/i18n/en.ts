...
export const EN_TRANSLATIONS: TranslationDictionary = {
  ...
  showcase: {
    ...
    tx_modal_title: 'Transaction Broadcasted!',
    tx_modal_subtitle: 'Your transaction has been successfully broadcast to the blockchain network',
    tx_modal_hash_label: 'TRANSACTION HASH (TX HASH)',
    tx_modal_view_explorer: 'View on {explorer}',
    tx_modal_amount: 'Amount Sent',
    tx_modal_recipient: 'Recipient',
    tx_modal_network: 'Network',
    tx_modal_status_broadcasted: 'Broadcasted to Mempool',
    tx_modal_btn_close: 'Got it / Close',
