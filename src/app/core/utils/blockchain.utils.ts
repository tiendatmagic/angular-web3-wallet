export const POPULAR_CHAINS = [
  ...
  { name: 'BSC Testnet', chainId: '97', rpcUrl: 'https://bsc-testnet.rpc.sentio.xyz', explorerUrl: 'https://testnet.bscscan.com', color: '#e6a817' },
];
...
export function getBackupRpcUrls(chainId: string | number): string[] {
  const id = chainId.toString().trim();
  switch (id) {
    case '97': return ['https://bsc-testnet.rpc.sentio.xyz', 'https://bsc-testnet.drpc.org', 'https://bsc-testnet-rpc.publicnode.com', 'https://bnb-testnet.api.onfinality.io/public'];
