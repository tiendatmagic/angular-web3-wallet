    ...
    <div>
      <div class="flex items-center justify-between mb-2">
        ...
        @if (stateService.txSpeed() === 'fast') {
          <span class="text-[10px] font-black text-primary bg-primary/10 px-2 py-0.5 rounded-md">1.5x Phí</span>
        } @else if (stateService.txSpeed() === 'custom') {
          <span class="text-[10px] font-black text-primary bg-primary/10 px-2 py-0.5 rounded-md">{{ stateService.gasMultiplier() }}x Phí</span>
        }
      </div>
